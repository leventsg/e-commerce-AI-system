...
-- ----------------------------
-- Table structure for ai_agent_runs
-- ----------------------------
...
-- ----------------------------
-- Table structure for ai_user_profiles
-- ----------------------------
...
-- ----------------------------
-- Table structure for order service local outbox_messages
-- ----------------------------
...
(
    ...
    created_at   TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3),
    PRIMARY KEY (pre_order_id, product_id),
