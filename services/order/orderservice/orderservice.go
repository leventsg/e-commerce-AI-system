...
func (m *defaultOrderService) HandlePaymentTimeoutOrder(ctx context.Context, in *HandlePaymentTimeoutOrderRequest, opts ...grpc.CallOption) (*EmptyRes, error) {
	client := order.NewOrderServiceClient(m.cli.Conn())
	return client.HandlePaymentTimeoutOrder(ctx, in, opts...)
}
