...
const (
	...
	OrderService_HandlePaymentTimeoutOrder_FullMethodName          = "/order.OrderService/HandlePaymentTimeoutOrder"
)
...
type OrderServiceClient interface {
	...
	HandlePaymentTimeoutOrder(ctx context.Context, in *HandlePaymentTimeoutOrderRequest, opts ...grpc.CallOption) (*EmptyRes, error)
}
...
func (c *orderServiceClient) HandlePaymentTimeoutOrder(ctx context.Context, in *HandlePaymentTimeoutOrderRequest, opts ...grpc.CallOption) (*EmptyRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyRes)
	err := c.cc.Invoke(ctx, OrderService_HandlePaymentTimeoutOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	HandlePaymentTimeoutOrder(context.Context, *HandlePaymentTimeoutOrderRequest) (*EmptyRes, error)
...
func (UnimplementedOrderServiceServer) HandlePaymentTimeoutOrder(context.Context, *HandlePaymentTimeoutOrderRequest) (*EmptyRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandlePaymentTimeoutOrder not implemented")
}
...
func _OrderService_HandlePaymentTimeoutOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HandlePaymentTimeoutOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).HandlePaymentTimeoutOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_HandlePaymentTimeoutOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).HandlePaymentTimeoutOrder(ctx, req.(*HandlePaymentTimeoutOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HandlePaymentTimeoutOrder",
			Handler:    _OrderService_HandlePaymentTimeoutOrder_Handler,
		},
	},
