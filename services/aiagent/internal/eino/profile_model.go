...
func profileStructuredOutputConfig() StructuredOutputConfig {
	return StructuredOutputConfig{
		...
		Strict:      true,
		Schema:      profileCandidateJSONSchema(),
	}
}

func profileCandidateJSONSchema() *jsonschema.Schema {
	return &jsonschema.Schema{
		...
		Properties: orderedmap.New[string, *jsonschema.Schema](
			orderedmap.WithInitialData[string, *jsonschema.Schema](
				orderedmap.Pair[string, *jsonschema.Schema]{
					Key:   "should_update",
					Value: &jsonschema.Schema{Type: string(schema.Boolean)},
				},
				orderedmap.Pair[string, *jsonschema.Schema]{
					Key: "update_type",
					Value: &jsonschema.Schema{
						...
						Enum: []any{
							profileextractor.UpdateTypeExplicitPreference,
							profileextractor.UpdateTypeStablePattern,
							profileextractor.UpdateTypeCorrection,
							profileextractor.UpdateTypeDeleteOrForget,
							profileextractor.UpdateTypeNone,
						},
					},
				},
				orderedmap.Pair[string, *jsonschema.Schema]{
				...
				orderedmap.Pair[string, *jsonschema.Schema]{
					Key:   "confidence",
					Value: &jsonschema.Schema{Type: string(schema.Number)},
				},
				orderedmap.Pair[string, *jsonschema.Schema]{
					Key:   "reason",
		...
		Required: []string{"should_update", "update_type", "profile_patch", "evidence_message_ids", "confidence", "reason"},
	}
}
